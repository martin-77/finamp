    ...
    try {
      ...
      for (final letter in letters) {
        ...
        try {
          ...
          recorder.metric("alphabetDirectOffsetDiagnostic", PerformanceBenchmarkService.alphabetDirectOffsetDiagnostic);
          await recorder.runStep(
            name: "alphabet-jump",
            timeout: const Duration(minutes: 30),
      ...
      recorder.diagnostic(
        "suite-error",
        values: {"phase": "targeted-alphabet", "errorType": error.runtimeType.toString()},
      );
    } finally {
      GetIt.instance<KeepScreenOnHelper>().setPerformanceBenchmarkOverride(false);
      recorder.stopHeartbeat();
